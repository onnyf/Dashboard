    ...
    <div className="fixed top-0 left-[268px] right-0 z-50 flex items-center justify-between px-6 py-4 bg-white shadow-sm border-b border-gray-200 h-[72px]">
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <input
            ...
            className="w-[341px] h-[44px] pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-green-600 font-gilroy-regular"
          />
      ...
      <div className="flex items-center space-x-6 ml-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center border border-gray-300 rounded-lg w-[129px] h-[40px] px-3 py-2 gap-2">
