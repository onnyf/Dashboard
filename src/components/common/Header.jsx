...
const Header = ({ onOpenInviteModal }) => {
  ...
  return (
    <header className="fixed top-0 left-0 md:left-[268px] right-0 flex items-center justify-between px-4 md:px-6 py-3 bg-white shadow-sm border-b border-gray-200 h-[72px] z-40">
      ...
      {/* Right Controls */}
      <div className="flex items-center space-x-4 md:space-x-6 ml-4 relative" ref={dropdownRef}>
        {/* Notification Bell */}
        <button
        ...
        {/* Dropdown Menu - No "View Profile" */}
        {showDropdown && (
          <div className="absolute top-[65px] right-0 bg-white shadow-md border rounded-md w-48 z-50">
