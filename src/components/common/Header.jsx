...
const Header = () => {
  ...
  return (
   <header className="fixed top-0 left-0 md:left-[268px] right-0 bg-white shadow-sm border-b border-gray-200 z-40 px-4 sm:px-6 py-3">
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    ...
    <div className="flex-1 w-full relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-[341px] h-[44px] pl-10 pr-4 py-2 border border-gray-300 text-[#4A4A4A] rounded-full focus:outline-none text-sm"
        />
      </div>
    ...
    {/* Right Controls */}
    <div className="flex items-center flex-wrap gap-3 sm:gap-4 md:gap-6 justify-end w-full sm:w-auto">
      {/* Notification Bell */}
      <button
      ...
      {showNotifications && (
        <div
          ...
          className="absolute top-20 right-4 sm:right-8 w-[360px] max-h-[500px] bg-white rounded-[24px] shadow-lg z-50 overflow-y-auto"
        >
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="text-6xl text-[#DCA332]">
              <GoBell />
            </div>
            <p className="mt-4 font-medium">No Notifications!</p>
            <p className="text-[#8E8E8E] text-sm">It is still empty here!</p>
          </div>
        </div>
      )}
